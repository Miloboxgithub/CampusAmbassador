  ...
  <view class="page-container">
      ...
      <view class="pers">
        <view class="items">
          ...
          <view class="sss">
			<view
              class="s1"
              bind:tap="navigate"
              data-url="/pkgA/pages/collection/collection"
            >
        ...
        <view class="items">
          ...
          <view class="sss">
            <view class="s2" bind:tap="navigate" data-url="/pkgA/pages/us/us">
            ...
            <view
              class="s2"
              bind:tap="navigate"
              data-url="/pkgA/pages/privacy/privacy"
            >
...
.meng {
  ...
  border-radius: 23px;
  left: 50%;
  transform: translateX(-50%); /* 旋转并保持居中 */
  z-index: 10;
}
.mengs {
  background-color: rgb(160, 70, 70, 0);
